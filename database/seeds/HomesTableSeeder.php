...
class HomesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $home = new \App\Home([
          ...
          'welcome_text' => 'Interior and Minimalist Furnite Service, Fungtional & Artistic Design',
...
           <p>Welcome to our digital gallery!</p>'
        ...
        $home = new \App\Home([
          'image' => 'http://res.cloudinary.com/fauzi41studio/image/upload/q_40/v1501726579/home-carousel_rggpxq.jpg',
          'welcome_text' => 'Jasa Desain Interior dan Furniture Minimalis, Fungsional & Artistik Desain',
