...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #fff;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      <div role="banner">
        ...
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="width: 600px"><![endif]-->
          <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 6px;Margin-bottom: 20px;color: #c3ced9;font-family: Roboto,Tahoma,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" align="center" id="emb-email-header"><img style="display: block;height: auto;width: 100%;border: 0;max-width: 100px;" src="{{ asset('img/niagaart-logo.png') }}" alt="" width="100" /></div>
          </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
        </div>
      </div>
      ...
      <div style="line-height:10px;font-size:1px">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <h3 class="size-12" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 12px;line-height: 19px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-12"><font color="#ffffff"><a style="color: inherit; text-decoration-style: none; text-decoration-line: none;" href="{{ route('service.all', ['locale' => 'id']) }}"><strong>SERVICES</strong></a></font></h3>
    </div>
      ...
      <div style="line-height:10px;font-size:1px">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <h3 class="size-12" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 12px;line-height: 19px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-12"><font color="#ffffff"><a style="color: inherit; text-decoration-style: none; text-decoration-line: none;" href="{{ route('projects', ['locale' => 'id']) }}"><strong>PROJECTS</strong></a></font></h3>
    </div>
      ...
      <div style="line-height:10px;font-size:1px">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <h3 class="size-12" style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #281557;font-size: 12px;line-height: 19px;font-family: Avenir,sans-serif;text-align: center;" lang="x-size-12"><span style="color:#fff"><a style="color: inherit; text-decoration-style: none; text-decoration-line: none;" href="{{ route('blog', ['locale' => 'id']) }}"><strong>BLOG</strong></a></span></h3>
    </div>
      ...
      <div style="background-color: #4b5462;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/j/B8/9F9/EC5/134342/csfinal/home-bg.jpg);background-repeat: repeat;">
        <div class="layout one-col" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          <div class="layout__inner" style="border-collapse: collapse;display: table;width: 100%;">
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #4b5462;background-position: 0px 0px;background-image: url(https://i1.createsend1.com/ei/j/B8/9F9/EC5/134342/csfinal/home-bg.jpg);background-repeat: repeat;"><td class="layout__edges">&nbsp;</td><td style="width: 600px" class="w560"><![endif]-->
            <div class="column" style="max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);text-align: left;color: #8e959c;font-size: 14px;line-height: 21px;font-family: sans-serif;">
      ...
      <h1 class="size-64" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #000;font-size: 44px;line-height: 50px;font-family: avenir,sans-serif;text-align: center;" lang="x-size-64"><span class="font-avenir"><strong><span style="color:#ffffff">
        Hello, you have a new message here
      </span></strong></span></h1>

      <ul style="color:#ffffff">
        <li style="color:#ffffff">Name : {{ $name }}</li>
        <li style="color:#ffffff">Email : {{ $email }}</li>
        <li style="color:#ffffff">Phone : {{ $phone }}</li>
        <li style="color:#ffffff">Message : {{ $user_message }}</li>
      </ul>
    </div>
...
<td class="emb-web-links" style="padding: 0;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="https://www.facebook.com/nafurniturebdg/"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/master/13-the-blueprint-3/images/facebook.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="https://twitter.com/niaga_art"><img style="border: 0;" src="https://i4.createsend1.com/static/eb/master/13-the-blueprint-3/images/twitter.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="https://www.youtube.com/channel/UCGBg-na9t31-N-w_sotxX0w"><img style="border: 0;" src="https://i3.createsend1.com/static/eb/master/13-the-blueprint-3/images/youtube.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="https://www.instagram.com/na_furniturebdg/"><img style="border: 0;" src="https://i5.createsend1.com/static/eb/master/13-the-blueprint-3/images/instagram.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #adb3b9;" href="http://www.linkedin.com"><img style="border: 0;" src="https://i6.createsend1.com/static/eb/master/13-the-blueprint-3/images/linkedin.png" width="26" height="26" /></a></td>
                </tr></tbody></table>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 20px;">
                  <div>Niaga Art<br />
Jl. Sangkuriang No. 43, Cimahi Utara 40511, Jawa Barat, Indonesia<br />
Phone :&nbsp;<a style="color: inherit; text-decoration-line: none;" href="tel:+622287800639">+62 22 878 00639</a><br />
Email :&nbsp;<a style="color: inherit; text-decoration-line: none;" href="mailto:cs@niagaart.com">cs@niagaart.com</a></div>
                </div>
                <div style="font-size: 12px;line-height: 19px;Margin-top: 18px;">
                  <div>Interior and Minimalist Furnite Service</div>
                </div>
                <!--[if mso]>&nbsp;<![endif]-->
              </div>
            </div>
