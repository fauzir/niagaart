      ...
      <div class="container service-scope1">
        <div class="row">
          <div class="container col-md-6 scope-img1">
            <img src="{{ asset('niagaart/images/service-scope1.jpg') }}" alt="Interior Design">
          </div>
          <div class="container col-md-6">
            <h3>HOME LIVING</h3>
            <br>
      ...
      <hr width="50%">
        ...
        <div class="row">
          ...
          <div class="container col-md-6 scope-img2">
            <img src="{{ asset('niagaart/images/service-scope2.jpg') }}" alt="Interior Design">
          </div>
        </div>
      </div>
      <hr width="50%">
       <div class="container service-scope3">
        <div class="row">
          <div class="container col-md-6 scope-img3">
            <img src="{{ asset('niagaart/images/service-scope3.jpg') }}" alt="Interior Design">
          </div>
          <div class="container col-md-6 scope-txt3">
            <h3>CAFE & FOODCOURT</h3>
            <br>
