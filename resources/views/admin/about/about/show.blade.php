        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">About {{ $about->id }}</div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <tbody>
                                    ...
                                    <tr><th> Image Header </th><td> {{ $about->image_header }} </td></tr><tr><th> Opening Image </th><td> {{ $about->opening_image }} </td></tr><tr><th> Opening Title </th><td> {{ $about->opening_title }} </td></tr>
                                </tbody>
                            </table>
                        </div>
