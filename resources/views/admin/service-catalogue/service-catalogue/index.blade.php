            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        {!! Form::open(['method' => 'GET', 'url' => '/admin/service-catalogue', 'class' => 'navbar-form navbar-right', 'role' => 'search'])  !!}
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless">
                                <thead>
                                    <tr>
                                        <th>ID</th><th>Opening Title</th><th>Opening Text</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
